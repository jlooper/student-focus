...
| AWS Spark | AWS Spark is an upcoming K12 program to encourage young learners to explore the AWS Cloud using hands-on activities. Currently in beta testing, includes a sandbox offering. | US-based high school educators and their students | Preview(Free) | US |
